   ...
   window.fbAsyncInit = function() {
	    ...
	    FB.getLoginStatus(function(response) {
		    ...
		    if (response.status === 'connected') {  //cuando esta conectado
				...
				FB.ui({
				      method: 'feed',
				      name: 'Cerremos con broche de oro',
				      link: 'https://www.promoscasaley.com.mx',
				      picture: 'https://www.promoscasaley.com.mx/img/principal_fbshare.jpg',
				      caption: 'Vigencia de la promoción: del 15 de Noviembre a 31 de Diciembre de 2017',
				      description: 'Gana espectaculares premios'
				    },
				    function(response) {
						if (response !=null) { 	
